...
<section class="flex flex-col gap-4">
	...
	<div class="grid grid-cols-2 gap-3 md:grid-cols-4">
		...
		<MetricCard
			...
			sublabel="acumulado 2026"
			accent="default"
		/>
	</div>

	<div class="grid grid-cols-12 gap-4">
		<!-- Produção por dia (semana) -->
		<div class="col-span-12 border border-slate-200 bg-white xl:col-span-7">
			<PanelHeader
				title="Produção por Dia · Semana Atual"
				subtitle="Volume diário de encaminhamentos consolidados"
				index="01"
			/>
			<div class="px-4 py-5">
		...
		<div class="col-span-12 flex flex-col gap-4 xl:col-span-5">
			...
			<div class="grid grid-cols-2 gap-3">
				<div class="border border-slate-200 bg-white px-4 py-3">
					...
					<div class="font-mono text-[10px] text-slate-500">PDF → consolidação</div>
				</div>
				<div class="border border-slate-200 bg-white px-4 py-3">
					<div class="font-mono text-[10px] tracking-widest text-slate-500 uppercase">
						Aprovação
					...
					<div class="font-mono text-[10px] text-slate-500">pós-regulação</div>
				</div>
			</div>

			<div class="border border-slate-200 bg-white">
				<PanelHeader title="Ranking da UBS" index="03" />
				<div class="flex items-center justify-between px-4 py-3">
					...
					<div class="text-right font-mono text-[11px] text-slate-600">
						de {p.producao.totalAtendentes} atendentes<br />
						vinculados à UBS Central
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-span-12 border border-slate-200 bg-white">
			<PanelHeader
				title="Encaminhamentos por Especialidade"
				subtitle="Top 5 especialidades — seu histórico"
				index="04"
			/>
